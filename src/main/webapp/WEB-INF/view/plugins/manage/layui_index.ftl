...
<head>
	...
	<script type="text/javascript" src="${rc.contextPath}/resources/common/plugins/jquery/swiper.jquery.min.js"></script>
            ...
            <ul id="nav">
                ...
                <li class="list">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a _href="member-level.html">
                                <i class="iconfont">&#xe6a7;</i>
                                等级管理
                            </a>
                        </li>
                        <li>
                            <a _href="member-kiss.html">
                                <i class="iconfont">&#xe6a7;</i>
                                积分管理
                            </a>
                        </li>
                        <li>
                            <a _href="member-view.html">
                                <i class="iconfont">&#xe6a7;</i>
                                浏览记录
                            </a>
                        </li>
                ...
                <li class="list" >
                    ...
                    <ul class="sub-menu" style="display:none">
                        ...
                        <li>
                            <a _href="http://echarts.baidu.com/examples.html">
                                <i class="iconfont">&#xe6a7;</i>
                                更多案例
                            </a>
                        </li>
